		...
		*/
		...
		Route::group(['middleware' => 'admin'], function () {
			...
			*/
			...
			Route::get('schedules/select-department', 'Admin\SchedulesController@select_department');
			...
			*/
			...
			Route::post('settings/languages', 'Admin\SettingsController@languages');
		...
		Route::group(['middleware' => 'employee'], function () {
			...
			*/
			...
			Route::post('personal/settings/languages', 'Personal\PersonalSettingsController@languages');
