...
@section('meta')
<title>{{ __('admin.Edit User') }} | {{ __('admin.Smart Timesheet') }}</title>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h2 class="page-title">{{ __('admin.Edit User') }}</h2>
        </div>
    </div>
                ...
                <div class="box-content">
                    ...
                    <form id="edit_user_form" action="{{ url('users/update/user') }}" class="ui form add-user" method="post"
                        ...
                        <div class="grouped fields opt-radio">
                            <label class="">{{ __('admin.Choose Account type') }}</label>
                            <div class="field">
                        ...
                        <div class="field">
                            ...
                            <select class="ui dropdown uppercase" name="status">
                                ...
                                <option value="1" @isset($u->status) @if($u->status == 1) selected @endif
                                    @endisset>{{ __('admin.Enabled') }}</option>
                                <option value="0" @isset($u->status) @if($u->status == 0) selected @endif
                                    @endisset>{{ __('admin.Disabled') }}</option>
                            </select>
                        </div>
                        <div class="two fields">
                            ...
                            <div class="field">
                                <label for="">{{ __('admin.Confirm New Password') }}</label>
