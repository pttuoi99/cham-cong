@extends('layouts.default')
    @section('meta')
    <title>{{ __('admin.Edit Employee Profile') }} | {{ __('admin.Smart Timesheet') }}</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">{{ __('admin.Edit Employee Profile') }}
                ...
                {{ csrf_field() }}
                            ...
                            <div class="box-body">
                                ...
                                <div class="field">
                                    ...
                                    <select name="gender" class="ui dropdown uppercase">
                                        ...
                                        <option value="MALE" @isset($person_details->gender) @if($person_details->gender == 'MALE') selected @endif @endisset>{{ __('admin.MALE') }}</option>
                                        <option value="FEMALE" @isset($person_details->gender) @if($person_details->gender == 'FEMALE') selected @endif @endisset>{{ __('admin.FEMALE') }}</option>
                                    </select>
                                </div>
                                <div class="field">
                                    ...
                                    <select name="civilstatus" class="ui dropdown uppercase">
                                        ...
                                        <option value="SINGLE" @isset($person_details->civilstatus) @if($person_details->civilstatus == 'SINGLE') selected @endif @endisset>{{ __('admin.SINGLE') }}</option>
                                        <option value="MARRIED" @isset($person_details->civilstatus) @if($person_details->civilstatus == 'MARRIED') selected @endif @endisset>{{ __('admin.MARRIED') }}</option>
                                        <option value="ANULLED" @isset($person_details->civilstatus) @if($person_details->civilstatus == 'ANULLED') selected @endif @endisset>{{ __('admin.ANULLED') }}</option>
                                        <option value="WIDOWED" @isset($person_details->civilstatus) @if($person_details->civilstatus == 'WIDOWED') selected @endif @endisset>{{ __('admin.WIDOWED') }}</option>
                                        <option value="LEGALLY SEPARATED" @isset($person_details->civilstatus) @if($person_details->civilstatus == 'LEGALLY SEPARATED') selected @endif @endisset>{{ __('admin.LEGALLY SEPARATED') }}</option>
                                    </select>
                                </div>
                                ...
                                <div class="two fields">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" name="weight" value="@isset($person_details->weight){{ $person_details->weight }}@endisset" placeholder="00">
                                    </div>
                                </div>
                                ...
                                <div class="two fields">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" name="birthday" value="@isset($person_details->birthday){{ $person_details->birthday }}@endisset" class="airdatepicker" placeholder="{{ __('admin.Date') }}">
                                    </div>
                                </div>
                                <div class="field">
                                ...
                                <div class="field">
                                    ...
                                    <input type="text" class="uppercase" name="birthplace" value="@isset($person_details->birthplace){{ $person_details->birthplace }}@endisset" placeholder="{{ __('admin.birthplace') }}">
                                </div>
                                <div class="field">
                                    <label>{{ __('admin.Home Address') }}</label>
                                    <input type="text" class="uppercase" name="homeaddress" value="@isset($person_details->homeaddress){{ $person_details->homeaddress }}@endisset" placeholder="{{ __('admin.homeaddress') }}">
                                </div>
                                <div class="field">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                ...
                                <div class="field">
                                    <label>{{ __('admin.Select Leave Privilege') }}</label>
                                ...
                                <div class="field">
                                    ...
                                    <select name="employmenttype" class="ui dropdown uppercase">
                                        ...
                                        <option value="Regular" @isset($person_details->employmenttype) @if($person_details->employmenttype == 'Regular') selected @endif @endisset>{{ __('admin.Regular') }}</option>
                                        <option value="Trainee" @isset($person_details->employmenttype) @if($person_details->employmenttype == 'Trainee') selected @endif @endisset>{{ __('admin.Trainee') }}</option>
                                    </select>
                                </div>
                                <div class="field">
                                    ...
                                    <select name="employmentstatus" class="ui dropdown uppercase">
                                        ...
                                        <option value="Active" @isset($person_details->employmentstatus) @if($person_details->employmentstatus == 'Active') selected @endif @endisset>{{ __('admin.Active') }}</option>
                                        <option value="Archived" @isset($person_details->employmentstatus) @if($person_details->employmentstatus == 'Archived') selected @endif @endisset>{{ __('admin.Archived') }}</option>
                                    </select>
                                </div>
                                <div class="field">
                                    <label>{{ __('admin.Official Start Date') }}</label>
                                    <input type="text" name="startdate" value="@isset($company_details->startdate){{ $company_details->startdate }}@endisset" class="airdatepicker" placeholder="{{ __('admin.Date') }}">
                                </div>
                                <div class="field">
                                    <label>{{ __('admin.Date Regularized') }}</label>
                                    <input type="text" name="dateregularized" value="@isset($company_details->dateregularized){{ $company_details->dateregularized }}@endisset" class="airdatepicker" placeholder="{{ __('admin.Date') }}">
                                </div>
                                <br>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 float-left">
                        <div class="action align-right">
                            ...
                            <button type="submit" name="submit" class="ui green button small"><i class="ui checkmark icon"></i> {{ __('admin.Update') }}</button>
