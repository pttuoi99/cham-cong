@extends('layouts.default')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">{{__('admin.Organization Profile')}}
                    <button class="ui basic button mini offsettop5 float-right" id="toggleview"><i class="ui icon columns"></i>{{__('admin.View')}}</button> 
                    <a href="{{ url('reports') }}" class="ui blue basic button mini offsettop5 float-right"><i class="ui icon chevron left"></i>{{__('admin.Return')}}</a>
                </h2>
            </div>    
        </div>
        ...
        <div class="row columnview">
            ...
            <div class="col-md-6 colview">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{__('admin.Company Population')}}</h3>
                    </div>
                    <div class="box-body">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{__('admin.Department Population')}}</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{__('admin.Gender Demographics')}}</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{__('admin.Age Demographics')}}</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{__('admin.Civil Status Demographics')}}</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{__('admin.Employee Hired by Year')}}</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
