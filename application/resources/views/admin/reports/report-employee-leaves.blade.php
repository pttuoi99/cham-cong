@extends('layouts.default')
    ...
    <div class="container-fluid">
        <div class="row">
            <h2 class="page-title">{{__('admin.Employee Leaves Report')}}
                    ...
                    <table width="100%" class="table table-striped table-hover" id="dataTables-example">
                        <thead>
                            <tr>
                                ...
                                <th>{{__('admin.Type')}}</th>
                                <th>{{__('admin.Leave from')}} <span class="help">({{__('admin.date')}})</span></th>
                                <th>{{__('admin.Leave to')}} <span class="help">({{__('admin.date')}})</span></th>
