@extends('layouts.personal')
    ...
    <div class="container-fluid">
        <div class="row">
            <h2 class="page-title">{{__('users.MY LEAVE')}}
                <button class="ui positive button mini offsettop5 btn-add float-right"><i class="icon plus"></i>{{__('users.REQUEST LEAVE')}}</button>
            </h2>
        </div>
            ...
            <div class="box box-success">
                <div class="box-body reportstable">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover delegation" id="dataTables-example">
                        <thead>
                            <tr>
                                <th>{{__('users.Leave Type')}}</th>
                                <th>{{__('users.Leave From')}}</th>
                                <th>{{__('users.Leave To')}}</th>
                                <th>{{__('users.Reason')}}</th>
                                <th>{{__('users.Return Date')}}</th>
