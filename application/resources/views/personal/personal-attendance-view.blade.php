@extends('layouts.personal')
    @section('meta')
    <title>My Attendances | Smart Timesheet</title>
    <meta name="description" content="smart timesheet my attendance, view all my attendances, and clock-in/out.">
    @endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
            <h2 class="page-title">{{__('users.My Attendances')}}</h2>
            </div>    
        </div>
                ...
                <div class="box-body reportstable">
                    ...
                    <table width="100%" class="table table-bordered table-hover" id="dataTables-example" data-order='[[ 0, "desc" ]]'>
                        <thead>
                            <tr>
                                <th>{{__('users.Date')}}</th>
                                <th>{{__('users.Time In')}}</th>
                                <th>{{__('users.Time Out')}}</th>
                                <th>{{__('users.Total Hours')}}</th>
                                <th>{{__('users.Status (In/Out)')}}</th>
                            </tr>
                        </thead>
                        <tbody>
                            @isset($a)
