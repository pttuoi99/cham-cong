@extends('layouts.personal')
    @section('meta')
    <title>My Profile | Smart Timesheet</title>
    <meta name="description" content="smart timesheet my profile, view my profile, and update my personal information.">
    @endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">{{__('users.PROFILE')}}
                    <a href="{{ url('personal/profile/edit') }}" class="ui basic blue button mini offsettop5 float-right"><i class="ui icon edit"></i>{{__('users.Edit')}}</a>
                </h2>
            </div>    
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8 float-left">
                <div class="box box-success">
                    <div class="box-header with-border">{{__('users.Personal Infomation')}}</div>
                    <div class="box-body employee-info">
                            <table class="tablelist">
                                <tbody>
                                    <tr>
                                        <td><p>{{__('users.Civil Status')}}</p></td>
                                        <td><p>@isset($profile->civilstatus) {{ $profile->civilstatus }} @endisset</p></td>
                                    </tr>
                                    <tr>
                                        <td><p>{{__('users.Age')}}</p></td>
                                        <td><p>@isset($profile->age) {{ $profile->age }} @endisset</p></td>
                                    </tr>
                                    <tr>
                                        <td><p>{{__('users.Height')}}<span class="help">(cm)</span></p></td>
                                    ...
                                    <tr>
                                        <td><p>{{__('users.Gender')}}</p></td>
                                        <td><p>@isset($profile->gender) {{ $profile->gender }} @endisset</p></td>
                                    </tr>
                                    <tr>
                                        <td><p>{{__('users.Date of Birth')}}</p></td>
                                        <td><p>
                                    ...
                                    <tr>
                                        <td><p>{{__('users.Date Regularized')}}</p></td>
                                        <td><p>
